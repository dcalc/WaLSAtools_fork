...
WaLSAtools is a collection of analysis routines (in both IDL and Python programming languages), collected and/or developed by the [**WaLSA team**](https://WaLSA.team){target=_blank}, for studying waves and oscillations, with a particular emphasis on such phenomena occurring in the lower atmosphere of the Sun.
...
This repository is primarily linked to an article in [**Nature Reviews Methods Primers**](https://www.nature.com/nrmp/){target=_blank} (to be submitted).

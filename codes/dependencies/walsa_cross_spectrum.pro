...
function walsa_getcross_spectrum, data1, data2, time, phase_angle=phase_angle, coherence=coherence, frequencies=frequencies, $
  ...
  ; mean_1 = total(x_1,1)/float(mn)
  ; mean_2 = total(x_2,1)/float(mn)
  ; x_1 = temporary(x_1) - transpose(rebin(mean_1,n_segments,mn,/sample))
  ; x_2 = temporary(x_2) - transpose(rebin(mean_2,n_segments,mn,/sample))

...
;
; CALLING SEQUENCE:
;      sjcurvefill, x, y1, y2, COLOR=, OUTLINECOLOR=, OUTHICK=
;   
; INPUTS:
...
;
;------------------------------------------------------------------------------
pro sjcurvefill, x, y1, y2, color = color, outlinecolor = outlinecolor $
                 , _EXTRA = EXTRA, OUTHICK = OUTHICK, xyreverse=xyreverse, x2=x2

  if  N_params() LT 3  then begin 
    print,'Syntax - ' + $
             'sjcurvefill, x, y1, y2, COLOR=, /LINE_FILL, ORIENTATION= [v1.1]'
    return
  endif 

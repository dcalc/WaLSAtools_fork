...
const char *epstool_version = "3.08";  /* should be EPSTOOL_VERSION */
const char *epstool_date = "2005-06-06"; /* should be EPSTOOL_DATE */
const char *copyright = "Copyright 1995-2005 Ghostgum Software Pty Ltd";
